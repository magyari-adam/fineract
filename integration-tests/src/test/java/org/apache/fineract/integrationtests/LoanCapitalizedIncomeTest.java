...
public class LoanCapitalizedIncomeTest extends BaseLoanIntegrationTest {
    ...
    public void testLoanCapitalizedIncomeAdjustment() {
        ...
        runAt("1 April 2024", () -> {
            ...
            loanTransactionHelper.capitalizedIncomeAdjustment(loanId, capitalizedIncomeIdRef.get(), "1 April 2024", 40.0);

            verifyTransactions(loanId, //
                    transaction(100.0, "Disbursement", "01 January 2024"), //
                    transaction(50.0, "Capitalized Income", "01 January 2024"), //
                    transaction(40.0, "Capitalized Income Adjustment", "01 April 2024") //
            );
            ...
            verifyJournalEntries(loanId, //
                    ...
                    journalEntry(50, loansReceivableAccount, "DEBIT"), //
                    journalEntry(50, deferredIncomeLiabilityAccount, "CREDIT"), //
                    journalEntry(40.0, deferredIncomeLiabilityAccount, "DEBIT"), //
                    journalEntry(39.42, loansReceivableAccount, "CREDIT"), //
                    journalEntry(0.58, interestReceivableAccount, "CREDIT") //
            );
        });
    }
    ...
    public void testLoanCapitalizedIncomeAdjustmentWithAmortizationAccounting() {
        ...
        runAt("3 January 2024", () -> {
            ...
            // Reverse-replay
            addRepaymentForLoan(loanId, 33.72, "2 January 2024");
            ...
            verifyTRJournalEntries(replayedCapitalizedIncomeAdjustmentOpt.get().getId(), //
                    journalEntry(49.99, loansReceivableAccount, "CREDIT"), //
    ...
    public void testLoanCapitalizedIncomeAdjustmentReversal() {
        ...
        runAt("1 April 2024", () -> {
            ...
            final PostLoansLoanIdTransactionsResponse capitalizedIncomeAdjustmentResponse = loanTransactionHelper
                    .capitalizedIncomeAdjustment(loanId, capitalizedIncomeIdRef.get(), "1 April 2024", 40.0);
            ...
            verifyJournalEntries(loanId, //
                    ...
                    journalEntry(39.42, loansReceivableAccount, "CREDIT"), //
                    journalEntry(0.58, interestReceivableAccount, "CREDIT"), //
                    journalEntry(40.0, deferredIncomeLiabilityAccount, "CREDIT"), //
                    journalEntry(39.42, loansReceivableAccount, "DEBIT"), //
                    journalEntry(0.58, interestReceivableAccount, "DEBIT") //
            );
        });
    }
